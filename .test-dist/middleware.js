...
exports.config = exports.middlewareTestUtils = void 0;
...
const SUPPORTED_LOCALES = ["pt-BR", "en-US", "fr", "ja"];
...
const getLocaleFromAcceptLanguage = (headerValue) => {
    if (!headerValue) {
        return null;
    }
...
const getCountryCode = (request) => {
    ...
    const providerCountry = request.headers.get("x-vercel-ip-country") || request.headers.get("cf-ipcountry");
